 ...
 * @param none 
 */
export async function askForUpload(script: nodeDoc.scriptT, all: boolean, none: boolean): Promise<string> {
 ...
 */
export async function ensureUploadScripts(scripts: nodeDoc.scriptT[]): Promise<[nodeDoc.scriptT[], nodeDoc.scriptT[]]> {
